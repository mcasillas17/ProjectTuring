...
func (c *eventServiceClient) SubscribeSessionEvents(ctx context.Context, in *SubscribeSessionEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[TuringEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &EventService_ServiceDesc.Streams[0], EventService_SubscribeSessionEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeSessionEventsRequest, TuringEvent]{ClientStream: stream}
...
func _EventService_SubscribeSessionEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(SubscribeSessionEventsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(EventServiceServer).SubscribeSessionEvents(m, &grpc.GenericServerStream[SubscribeSessionEventsRequest, TuringEvent]{ServerStream: stream})
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "turing.v1.EventService",
	...
	Metadata: "turing/v1/events.proto",
}
